...
start "📊 Unified Workflow Logger - Job Search App Tracker" cmd /k "title Unified Workflow Logger - Job Search App Tracker && cd /d %CD%\backend && echo. && echo ================================================ && echo    🚀 UNIFIED WORKFLOW LOGGER STARTED && echo ================================================ && echo. && echo 📋 Tracking: && echo   • User navigation ^& screen transitions && echo   • Button clicks ^& form submissions && echo   • Job scraping processes ^& progress && echo   • API calls ^& backend processes && echo   • Errors ^& system events && echo. && echo ⚙️  Backend server starting... && echo. && node server.js"
